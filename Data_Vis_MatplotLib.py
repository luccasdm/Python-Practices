# -*- coding: utf-8 -*-
"""Data_Vis_ Hands_On_Matplotlib.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PffML33RURJnBbEwFRcRluUgaMmkNhLv
...
ax.grid(linestyle=":", linewidth=1.0, color='.25', zorder=-10)
...
ax.plot(X, Y3, linewidth=0, marker='v', markerfacecolor='green', markeredgecolor='green')

ax.set_title("Luccas Del Mastro Garcia", fontsize=20, verticalalignment='bottom')
...
plt.savefig("Matplotlib_Luccas_Garcia.png")
files.download("Matplotlib_Luccas_Garcia.png")